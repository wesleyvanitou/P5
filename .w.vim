...
wincmd w
argglobal
if bufexists("pkg/config/tables.py") | buffer pkg/config/tables.py | else | edit pkg/config/tables.py | endif
let s:cpo_save=&cpo
set cpo&vim
noremap <buffer> <F7> :call flake8#Flake8()
let &cpo=s:cpo_save
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 35 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
exe 'vert 3resize ' . ((&columns * 119 + 119) / 239)
tabnext 1
badd +53 pkg/retrieve.py
badd +13 pkg/config/tables.py
badd +1 main.py
badd +0 .env
